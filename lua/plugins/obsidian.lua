return {
  ...
  config = function()
    ...
    --
    -- navigate to vault
    vim.keymap.set('n', '<leader>od', ':cd /Users/marctalcott/Obsidian/MarcsDailyNotes<cr>')
    --
    ...
    vim.keymap.set('n', '<leader>os', ':Telescope find_files search_dirs={"~/Obsidian/MarcsDailyNotes"}<cr>')
    vim.keymap.set('n', '<leader>oz', ':Telescope live_grep search_dirs={"~/Obsidian/MarcsDailyNotes"}<cr>')
    --
